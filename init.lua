...
-- [[ Setting options ]]
-- NOTE: Moved all options to separate `options.lua` file
-- See `:help vim.opt`
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      -- Register suggestion from ChatGPT
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ss', builtin.live_grep, { desc = '[S]earch with Ripgrep' })
      vim.keymap.set('n', '<leader>sw', builtin.grep_string, { desc = '[S]earch current [W]ord' })
      vim.keymap.set('n', '<leader>sg', builtin.git_files, { desc = '[S]earch [G]it Files' })
      vim.keymap.set('n', '<leader>sd', builtin.diagnostics, { desc = '[S]earch [D]iagnostics' })
      vim.keymap.set('n', '<leader>sr', builtin.resume, { desc = '[S]earch [R]esume' })
      vim.keymap.set('n', '<leader>sz', builtin.current_buffer_fuzzy_find, { desc = '[S]earch Current Buffer Fu[z]zily' })
